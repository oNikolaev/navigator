	...
	Для каждого ПодчиненныйЭлемент Из КоллекцияЭлементов Цикл
		...
		Если ТипЗнч(ПодчиненныйЭлемент) = Тип("КнопкаФормы") Тогда
			...
			Если ИмяЭлементаКоллекции = "Отчет" Или ИмяЭлементаКоллекции = "Обработка" Тогда
				...
				Если ПодчиненныйЭлемент.Имя = "КомандаОткрытьОтчетОбработкуФорму" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
				
				Если ПодчиненныйЭлемент.Имя = "КомандаОтобразитьСвойстваОбъектаМетаданных" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
				
				Если ПодчиненныйЭлемент.Имя = "КомандаОтобразитьСтруктуруОбъектаМетаданных" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
			...
			ИначеЕсли ИмяЭлементаКоллекции = "Форма" Тогда
				...
				Если ПодчиненныйЭлемент.Имя = "КомандаОткрытьФормуСПараметромАвтоТест" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
			...
			ИначеЕсли ИмяЭлементаКоллекции = "Документ" Или ИмяЭлементаКоллекции = "Справочник" 
				...
				Если ПодчиненныйЭлемент.Имя = "КомандаОтобразитьСтруктуруХраненияОбъектаМетаданных" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
				
				Если ПодчиненныйЭлемент.Имя = "КомандаОтобразитьКоличество" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
			...
			ИначеЕсли ИмяЭлементаКоллекции = "Макет" Тогда
				...
				Если ПодчиненныйЭлемент.Имя = "КомандаОткрытьМакет" Тогда
					ПодчиненныйЭлемент.Видимость = Истина;
				КонецЕсли;
