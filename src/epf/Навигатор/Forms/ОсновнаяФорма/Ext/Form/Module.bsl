...
Процедура КомандаВставитьДанныеИзБуфераОбмена(Команда)
	...
	Для каждого эл_Буфер Из м_БуферОбмена Цикл
		...
		стр_ЭлементПроекта.Имя = эл_Буфер;
		стр_ЭлементПроекта.Представление = эл_Буфер;
		стр_ЭлементПроекта.Значение = эл_Буфер;
		стр_ЭлементПроекта.Тип = "ЭлементПроекта";
...
Асинх Процедура ПередНачаломДобавленияПроекта()
	...
	эл_ГруппаСсылки.НомерКартинки = 2;
...
Процедура СписокЭлементовОбъектаМетаданныхНастроитьКолонки(ИмяЭлементаКомандыНастройки)
	...
	Для каждого ЭлКолонка Из Элементы[ИмяЭлементаСписка].ПодчиненныеЭлементы Цикл
		...
		ЧастиСтрокиПутьКДанным = СтрРазделить(ЭлКолонка.ПутьКДанным, ".");
