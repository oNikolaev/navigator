...
Процедура ЗаполнитьВсеРеквизиты()
	...
	стр_СистемныеРеквизиты.Представление     = СтрШаблон("СистемныеРеквизиты (%1)", 2);
	...
	стр_СистемныеРеквизиты.Представление = СтрШаблон("СистемныеРеквизиты (%1)", стр_СистемныеРеквизиты.Строки.Количество());
	...
	Если МетаданныеОбъекта.СтандартныеРеквизиты.Количество() > 0 Тогда
		...
		стр_СтРеквизиты.Представление     = СтрШаблон("СтандартныеРеквизиты (%1)", МетаданныеОбъекта.СтандартныеРеквизиты.Количество());
