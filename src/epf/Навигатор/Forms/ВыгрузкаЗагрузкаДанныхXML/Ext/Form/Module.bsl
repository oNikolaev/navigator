...
Функция ПолноеИмяФайлаПоДаннымОбъекта(СсылкаНаОбъект)
	...
	Если ИмяТипа = "Документ" Тогда
		...
		ПолноеИмяФайла = Навигатор.ПодставитьПараметрыВСтроку("%1.%2.%3.%4.%5", 
	...
	Иначе
		...
		ПолноеИмяФайла = Навигатор.ПодставитьПараметрыВСтроку("%1.%2.%3.%4", ИмяТипа, ИмяОбъекта, "Код", ВерсияДанных);
