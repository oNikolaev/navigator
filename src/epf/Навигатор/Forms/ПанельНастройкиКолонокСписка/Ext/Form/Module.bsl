...
Процедура Настроить(Форма, ИмяЭлементаКомандыНастройки) Экспорт
	...
	СтроковыеФункции = ПолучитьФорму("ВнешняяОбработка.Навигатор.Форма.СтроковыеФункции");
	
	ЧастиСтроки = СтроковыеФункции.РазложитьСтрокуВМассивПодстрок(ИмяЭлементаКомандыНастройки, Объект.Система_РазделительЧастейИмен);
	...
	ИмяЭлементаСписка = СтроковыеФункции.СтрокаИзМассиваПодстрок(ЧастиСтрокиИмениЭлементаСписка, Объект.Система_РазделительЧастейИмен);
